...
print(diff(f, 2, h=0.001, mode=0))  # forward difference
print(diff(f, 2, h=0.001, mode=1))  # backward difference
print(diff(f, 2, h=0.001, mode=2))  # central difference
print(diff(f, 2, h=0.001, mode=3))  # five-point difference
